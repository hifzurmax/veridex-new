    ...
    <header className="sticky top-0 z-50 border-b border-line/60 bg-ink/80 backdrop-blur-md">
      <div className="container-edge flex h-14 items-center justify-between text-paper">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#contact" className="inline-flex items-center gap-2 border border-paper/20 bg-paper text-ink px-3.5 py-1.5 text-[13px] font-medium hover:bg-paper/90 transition-colors">
            {t.nav.cta}
